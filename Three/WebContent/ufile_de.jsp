                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li class="active"><a href="ofile_de.jsp">File View</a></li>
                           
                            <li><a href="udown.jsp">Download</a></li>
                ...
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <table border="1" style="text-align: center;margin-left: 0px">
                        <tr>
                            ...
                            <th style="text-align: center;width: 100px;color: crimson; font-size: 14px">Canot_Update</th>
                        ...
                        <tr>
                            ...
                            <td style="color: #4CAF50; font-size: 16px"><a href="update.jsp?mac1=<%=rs.getString("mac1")%>"><font style="color: green"></a></td>
