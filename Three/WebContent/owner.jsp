            ...
            <div class="content">
                <div class="content_resize"> <img src="images/slide3.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <div class="article">
                      ...
                      <br><center><font style="font-family: fantasy; font-size: x-large; color: #595959; font-style: inherit">OWNER LOGIN</font><br>
                    <br><form action="ologin.jsp" method="get"> 
                        ...
                        <input type="password" class="inputs" name="pass" required="" placeholder="Password" /><br> 
                            <input type="password" class="inputs" name="skey" required="" placeholder="OTP" /><br> 
