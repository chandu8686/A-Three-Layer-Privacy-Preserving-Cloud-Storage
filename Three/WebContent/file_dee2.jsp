                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                       <ul>
                            ...
                            <li class="active"><a href="file_dee2.jsp">File Details</a></li>
                         
                            <li><a href="down_dee.jsp">Download History</a></li>
                ...
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <table border="1" style="text-align: center;margin-left: 10px">
                        <tr>
                            ...
                            <th style="text-align: center;width: 100px;color: black; font-size: 14px">LOCAL</th>
                            <th style="text-align: center;width: 100px;color: black; font-size: 14px">FOG</th>
                            <th style="text-align: center;width: 100px;color: black; font-size: 14px">CLOUD</th>
